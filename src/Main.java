...
/**
 * Клас, який представляє консольний додаток для роботи з колекцією тварин.
 */
public class Main {
    // Список тварин
    private static List<Animal> animals = new ArrayList<>();
    // Об'єкт для зчитування введення користувача
    public static Scanner sc = new Scanner(System.in);

    /**
     * Головний метод додатку.
     *
     * @param args аргументи командного рядка (не використовуються у цьому додатку)
     */
    ...
    /**
     * Метод виводить довідку про типи тварин.
     */
    ...
    /**
     * Метод для створення нової тварини з введеними користувачем параметрами.
     */
    ...
    /**
     * Метод для виведення інформації про обрану тварину.
     */
    ...
    /**
     * Метод для видалення обраної тварини зі списку.
     */
